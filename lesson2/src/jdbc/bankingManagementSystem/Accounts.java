    ...
    private long generateAccountNumber(){
        try{
            ...
            if(resultSet.next()){
                ...
                return last_account_number + 1; // Новые аккаунты будут иметь номер равный самому большому существующему номеру из таблицы + 1
            }
        } catch(SQLException e){
            e.printStackTrace();
        }
        return 10000100; // Первый аккаунт будет иметь такой номер
    }
