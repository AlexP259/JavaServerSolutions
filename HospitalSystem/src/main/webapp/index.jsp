        ...
        <div class="advantages__block">
            <div class="advantages__element-left">
                <div>
                    ...
                    <p>В лаборатории анализаторы последнего поколения с функциями Rerun и Reflex. В кабинете УЗИ аппарат
                        с детализацией X-insight и технологией Auto EF</p>
                </div>
                <div>
                    <h4>Анализы за 3 часа</h4>
                    <p>Собственная лаборатория выполнит анализы пока вы будете на приеме и УЗИ. Комплекс обследований
                        всего за 2 часа. Доплата за срочность всего 500 ₽</p>
                </div>
                <div>
                    <h4>Комплексные обследования</h4>
                    <p>Комплексные обследования в сфере гинекологии, урологии, кардиологии, аллергологии, неврологии и
                        других. Более 30 видов УЗИ и 1000 исследований</p>
                </div>
                <div>
                    <h4>Детальное узи</h4>
                    <p>Расширенный угол обзора и высокая детализация изображения позволяют увидеть даже незначительные
                        изменения и сделать полное описание</p>
                </div>
            </div>
